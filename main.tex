...
\tagline{Senior Engineer - Embedded Software}
\personalinfo{
    \email{\href{mailto:jonessos.ben@gmail.com}{jonessos.ben@gmail.com}}
    \phone{+91 7907697244}
    \location{Ernakulam, Kerala, India}
    \linkedin{\href{https://www.linkedin.com/in/jonessos/}{jonessos}}
    \github{\href{https://github.com/jonessos}{jonessos}}
}
...
\begin{itemize}
\item 3 years of overall work experience in the 5G \& Data Center domain
\item Experienced in Linux, 5G, O-RAN, Middleware, Yocto Project, Application Softwares, and Software Integration
\end{itemize}

\cvsection{Experience}

\cvevent{Senior Engineer (SW)}{VVDN Technologies Pvt. Ltd}{Nov 2020 -- Present}{Kochi, Kerala}
...
\begin{itemize}
\item End-to-End PHY layer processing from demodulation to channel
decoding
\item Implemented algorithms for phase compensation, channel estima-
tion and equalisation, and channel decoding of PBCH, PDCCH and
PDSCH channels
\item Decoded the MIB obtained after decoding PBCH, DCI\_1\_0 message from PDCCH, and SIB1 message from PDSCH channel
\item Extracting the tdd-ul-dl-conﬁgCommon field from SIB1 and
UPER decoding the L3 data into ASN1 format
\end{itemize}

\divider

\cvsubsection{Verification of FPGA designs for accelerated cloud security}
\begin{itemize}
